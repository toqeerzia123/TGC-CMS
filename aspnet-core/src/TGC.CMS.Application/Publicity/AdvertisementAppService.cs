...
{
    public class AdvertisementAppService : AsyncCrudAppService<Advertisement, AdvertListDto, int, AdvertResultRequestDto, AdvertCreateDto, AdvertUpdateDto>, IAdvertisementAppService
    {
        private IWebHostEnvironment _environment;
        private readonly IUnitOfWorkManager _unitOfWorkManager;
        private readonly IConfiguration _configuration;
        public AdvertisementAppService(IUnitOfWorkManager unitOfWorkManager,
